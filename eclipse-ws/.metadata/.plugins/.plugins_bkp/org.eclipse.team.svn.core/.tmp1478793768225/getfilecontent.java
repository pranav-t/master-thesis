...
//		statusReport += viewManager.getProcessing().getStatisticVU().getMaxThroughput().get()+SystemConfig.MESSAGES_SPLITCONTENTSEQUENCE;
		...
		statusReport += viewManager.getProcessing().getStatisticsProjection().getTotalUpdates()+";";
		statusReport += viewManager.getProcessing().getStatisticsProjection().getAvgLatency()+";";
		statusReport += viewManager.getProcessing().getStatisticsSelection().getTotalUpdates()+";";
		statusReport += viewManager.getProcessing().getStatisticsSelection().getAvgLatency()+";";
		statusReport += viewManager.getProcessing().getStatisticsDelta().getTotalUpdates()+";";
		statusReport += viewManager.getProcessing().getStatisticsDelta().getAvgLatency()+";";
		statusReport += viewManager.getProcessing().getStatisticsPreAggregation().getTotalUpdates()+";";
		statusReport += viewManager.getProcessing().getStatisticsPreAggregation().getAvgLatency()+";";
		statusReport += viewManager.getProcessing().getStatisticsJoin().getTotalUpdates()+";";
		statusReport += viewManager.getProcessing().getStatisticsJoin().getAvgLatency()+";";
			...
			try{
			   ...
			   if((currentTime - lastMeasureStatistic) > 1000){
				   lastMeasureStatistic = currentTime;
 				   ...
 				   viewManager.getProcessing().getStatisticsProjection().measureTroughput();
 				   viewManager.getProcessing().getStatisticsDelta().measureTroughput();
 				   viewManager.getProcessing().getStatisticsPreAggregation().measureTroughput();
 				   viewManager.getProcessing().getStatisticsJoin().measureTroughput();
 				   viewManager.getProcessing().getStatisticsSelection().measureTroughput();
 				   ...
 				   viewManager.getProcessing().getStatisticsProjection().measureLatency();
 				   viewManager.getProcessing().getStatisticsDelta().measureLatency();
 				   viewManager.getProcessing().getStatisticsPreAggregation().measureLatency();
 				   viewManager.getProcessing().getStatisticsJoin().measureLatency();
 				   viewManager.getProcessing().getStatisticsSelection().measureLatency();
			   }
