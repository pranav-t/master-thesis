...
//	public static void sendToSystemID(Log log, IMessageComponent mc, String target, String operation, String content){
//		
//		if(content == null)content = mc.getSystemID().toString();
//		
//		SystemID systemID = new SystemID(target);
//		
//		Message message = new Message(mc.getComponent(), mc.getSystemID().toString(), operation, content);
//		
//		MessageClient.send(log, systemID.getIp(), systemID.getMessagePort(), message);	
//		
//		
//	}
//	
//	public static void sendMessage(Log log, IMessageComponent source, SystemID target, String operation, String content){
//		
//		if(content == null)content =  source.getSystemID().toString();
//		
//		Message message = new Message(source.getComponent(), source.getSystemID().toString(), operation, content);
//		
//		MessageClient.send(log, target.getIp(), target.getMessagePort(), message);	
//		
//		
//	}
	...
	public static void sendMessage(Log log, String receiver, Message message){
		
		
		SystemID systemID2 = new SystemID(receiver);
		
		MessageClient.send(log, systemID2.getIp(), systemID2.getMessagePort(), message);	
		
		
	}
	
	public static void sendMessage(Log log, SystemID receiver, Message message){
		
		
//		SystemID masterID = new SystemID(systemID);
		
		MessageClient.send(log, receiver.getIp(), receiver.getMessagePort(), message);	
