...
public class Addition extends MathOperator{
	...
	public Object eval(TableRecord tableRecord)  throws Exception{
		...
		if(leftVal instanceof String && rightVal instanceof String){
			return (String)leftTerm.eval(tableRecord) + (String)rightTerm.eval(tableRecord);
		}
	...
	public Object evalGrouping(List<TableRecord> tableRecords) throws Exception {
		...
		if(tableRecords.size() > 0){
			...
			if(leftVal instanceof String && rightVal instanceof String){
				return (String)leftTerm.evalGrouping(tableRecords)+(String)rightTerm.evalGrouping(tableRecords);
			}
