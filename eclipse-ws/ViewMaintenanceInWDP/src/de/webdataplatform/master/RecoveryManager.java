...
//			
//			commitLog = new CommitLog(log, viewManager.getName());
//			
//
...
//			
//			Command command = new Command(Command.REGIONSERVER_WITHDRAW_CRASHED_VM, viewManager, regionServer);
//			executeCommand(command);
//			
//			if(logOpen && highestSequenceNos.keySet().size() != 0){
//					
//				command = new Command(Command.REGIONSERVER_REPLAY_WRITEAHEADLOG, viewManager, regionServer, highestSequenceNos.toString());
//				executeCommand(command);
//			}
//			
//		}else{
...
//		List<SystemID> affectedViewManagers = metaData.getAssignedViewManagers().get(regionServer);
//		
//		if(affectedViewManagers != null && affectedViewManagers.size() > 0){
//			
//			for(SystemID viewManager : affectedViewManagers){
//				
