...
public class SystemConfig {
		...
		public static Integer REGIONSERVER_SENDINGTHREADS;
		
		public static Integer CLIENT_LOGINTERVAL;
		public static String CLIENT_TPCH_DIRECTORY;
		...
		public static String MESSAGES_SPLITCONTENTSEQUENCE2;
		...
		public static String RECORDS_SPLITROWKEYKVPAIRS;
		public static String RECORDS_SPLITKVPAIRS;
		public static String RECORDS_SPLITKV;
		public static String RECORDS_SPLITDELTA;
		public static String RECORDS_SPLITPREAGGREGATION;
		public static String RECORDS_SPLITREVERSEJOIN;
		public static String RECORDS_DATEFORMAT;
...
//			log.info(SystemConfig.class, "Loading system config:");
		    ...
		    SystemConfig.CLIENT_TPCH_DIRECTORY = config.getString("systemconfig.client.tpchDirectory");
		    ...
		    SystemConfig.REGIONSERVER_READWALDELAY = Long.parseLong(config.getString("systemconfig.regionServer.readWALDelay"));
		    ...
		    SystemConfig.REGIONSERVER_SENDINGTHREADS = Integer.parseInt(config.getString("systemconfig.regionServer.sendingThreads"));
		    ...
		    SystemConfig.MESSAGES_SPLITCONTENTSEQUENCE2 = config.getString("systemconfig.messages.splitContentSequence2");
		    ...
		    SystemConfig.RECORDS_SPLITROWKEYKVPAIRS = config.getString("systemconfig.records.splitRowkeyKVPairs");
		    SystemConfig.RECORDS_SPLITKVPAIRS = config.getString("systemconfig.records.splitKVPairs");
		    SystemConfig.RECORDS_SPLITKV = config.getString("systemconfig.records.splitKV");
		    
		    SystemConfig.RECORDS_SPLITDELTA = config.getString("systemconfig.records.splitDelta");
		    SystemConfig.RECORDS_SPLITPREAGGREGATION = config.getString("systemconfig.records.splitPreAggregation");
		    SystemConfig.RECORDS_SPLITREVERSEJOIN = config.getString("systemconfig.records.splitReverseJoin");
		    SystemConfig.RECORDS_DATEFORMAT = config.getString("systemconfig.records.dateFormat");
...
//		    log.info(SystemConfig.class, "SystemConfig.REGIONSERVER_READWALDELAY:"+SystemConfig.REGIONSERVER_READWALDELAY);
...
//		    log.info(SystemConfig.class, "SystemConfig.MESSAGES_SPLITCONTENTSEQUENCE2:"+SystemConfig.MESSAGES_SPLITCONTENTSEQUENCE2);
...
//		
//		    log.info(SystemConfig.class, "SystemConfig.RECORDS_SPLITDELTA:"+SystemConfig.RECORDS_SPLITDELTA);
//		    log.info(SystemConfig.class, "SystemConfig.RECORDS_SPLITPREAGGREGATION:"+SystemConfig.RECORDS_SPLITPREAGGREGATION);
//		    log.info(SystemConfig.class, "SystemConfig.RECORDS_SPLITREVERSEJOIN:"+SystemConfig.RECORDS_SPLITREVERSEJOIN);
//
