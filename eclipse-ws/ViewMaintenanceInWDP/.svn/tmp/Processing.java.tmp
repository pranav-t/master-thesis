...
//	
	...
	private StatisticsElement statisticsDelta;
	
	private StatisticsElement statisticsProjection;
	
	private StatisticsElement statisticsSelection;
	
	private StatisticsElement statisticsPreAggregation;
	
	private StatisticsElement statisticsJoin;
...
//		this.updateAssigner = updateAssigner;
		...
		statisticsDelta = new StatisticsElement();
		statisticsProjection = new StatisticsElement();
		statisticsSelection = new StatisticsElement();
		statisticsPreAggregation = new StatisticsElement();
		statisticsJoin = new StatisticsElement();
...
//			
			...
			if(null != update) {
				...
				log.info(Processing.class, update);
				log.info(Processing.class, "*-------***--------*");
			}
...
//		if(System.currentTimeMillis() - start < 100)completeBT+=(System.currentTimeMillis()-start);
//		System.out.println("COMPLETE_BTTime: "+completeBT);
	}
	
//	private long completeBT=0;
...
//		System.out.println("GETTIME: "+(System.currentTimeMillis()-start0));
...
//			oldViewRecord = deltaRecord.getNewRecord();
		...
		statisticsDelta.recordLatency(System.nanoTime()-start);
	...
	public BaseTableUpdate updateProjectionView(BaseTableUpdate btu, ViewUpdate viewUpdate, Projection projection){
		...
		statisticsProjection.recordUpdate();
		long start = System.nanoTime();
...
//		}
		...
		statisticsProjection.recordLatency(System.nanoTime()-start);
	...
	public BaseTableUpdate updateSelectionView(BaseTableUpdate btu, ViewUpdate viewUpdate, Selection selection){
		...
		statisticsSelection.recordUpdate();
		long start = System.nanoTime();
		...
		if(type.equals("Put")){
			...
			if(!isMatching){
				...
				if(viewRecord != null){
					...
					statisticsSelection.recordLatency(System.nanoTime()-start);
					return null;
				}
			}
			btu.getRecord().setTableName(viewTableName);
...
//				}
	...
	public BaseTableUpdate updatePreAggregationView(BaseTableUpdate btu, ViewUpdate viewUpdate, PreAggregation preAggregation){
		...
		statisticsPreAggregation.recordUpdate();
		long start = System.nanoTime();
...
//		System.out.println("AGGTime: "+(System.currentTimeMillis()-start2));
		...
		statisticsPreAggregation.recordLatency(System.nanoTime()-start);
...
//		prepare incremental update operations
		...
		statisticsJoin.recordLatency(System.nanoTime()-start);
	...
	public StatisticsElement getStatisticsDelta() {
		return statisticsDelta;
	}


	public void setStatisticsDelta(StatisticsElement statisticsDelta) {
		this.statisticsDelta = statisticsDelta;
	}


	public StatisticsElement getStatisticsProjection() {
		return statisticsProjection;
	}


	public void setStatisticsProjection(StatisticsElement statisticsProjection) {
		this.statisticsProjection = statisticsProjection;
	}


	public StatisticsElement getStatisticsPreAggregation() {
		return statisticsPreAggregation;
	}


	public void setStatisticsPreAggregation(
			StatisticsElement statisticsPreAggregation) {
		this.statisticsPreAggregation = statisticsPreAggregation;
	}


	public StatisticsElement getStatisticsSelection() {
		return statisticsSelection;
	}


	public void setStatisticsSelection(StatisticsElement statisticsSelection) {
		this.statisticsSelection = statisticsSelection;
	}


	public StatisticsElement getStatisticsJoin() {
		return statisticsJoin;
	}


	public void setStatisticsJoin(StatisticsElement statisticsJoin) {
		this.statisticsJoin = statisticsJoin;
	}
