...
//		      System.out.println("matcherGroup: "+matcherGroup);
		    ...
		    if(matches == 0 && message.contains(SystemConfig.MESSAGES_ENDSEQUENCE) && message.contains(SystemConfig.MESSAGES_STARTSEQUENCE)){
//		    	System.out.println(message.indexOf(">"));
//		    	System.out.println(message.indexOf("<"));
		    	result.add(message.substring(0, message.indexOf(SystemConfig.MESSAGES_ENDSEQUENCE)+1));
		    	matcherEnd =  message.indexOf(SystemConfig.MESSAGES_STARTSEQUENCE);
		    }
